...
export default function DeleteRoomButton({ id, roomNumber }: DeleteRoomButtonProps) {
    ...
    <div>
      ...
      {confirmOpen && (
        <ConfirmDialog
          ...
          description={`Are you sure you want to delete room "${roomNumber}"? This will remove it from the website and database.`}
          confirmLabel="OK"
          loading={loading}
          error={error}
          onCancel={() => {
